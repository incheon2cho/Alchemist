...
#### Video-MME 공식 Task Type (12종)

Video-MME는 12개의 공식 task_type을 제공한다. 다음 eval부터 공식 분류 기준으로 분석 예정:

| Task Type | QA 수 | 카테고리 |
|-----------|:---:|------|
| Object Reasoning | 454 | 객체 관계 추론 |
| Object Recognition | 354 | 객체 인식 |
| Information Synopsis | 323 | 정보 요약 |
| Action Recognition | 313 | 동작 인식 |
| Action Reasoning | 285 | 동작 추론 |
| Counting Problem | 268 | 수 세기 |
| Attribute Perception | 222 | 속성 인지 |
| Temporal Reasoning | 177 | 시간 추론 |
| OCR Problems | 139 | 텍스트 읽기 |
| Spatial Reasoning | 56 | 공간 추론 |
| Temporal Perception | 55 | 시간 인지 |
| Spatial Perception | 54 | 공간 인지 |
